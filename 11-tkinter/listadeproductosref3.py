...
class Lista_de_productos(object):
    def __init__(self):
        ...
        # self.ventana.geometry("500x500") # Susutituido por minsize()
        self.ventana.minsize(500, 500)
        self.ventana.resizable(0, 0)
        self.ventana.title("Lista de productos de EOI")
        self.ventana.iconbitmap("./11-tkinter/imagenes/EOI.ico")
                
        # Etiqueta de Inicio en la pantalla Inicio
        self.home_label = Label(self.ventana, text="Inicio")

        # Frame para manejar todos los widgets a la vez dentro del listado de pantalla de inicio
        self.products_box = Frame(self.ventana, width=250)

        # Etiqueta de Añadir en la pantalla Añadir
        self.add_label = Label(self.ventana, text="Añadir")

        # Etiqueta de Información en la pantalla Información
        self.info_label = Label(self.ventana, text="Información")

        # Etiqueta de Política de Productos en la pantalla información
        self.data_label = Label(self.ventana, text="Politica de calidad de nuestro productos")

        # Formulario de productos en la pantalla de Añadir
        self.add_frame = Frame(self.ventana) # Frame para manejar todos los widgets a la vez dentro del frame
        ...
        self.menu_superior.add_command(label="Salir", command=self.ventana.quit)
