...
- (Hecho) Mostrar datos listados en la pantalla inicio
"""
...
ventana.title("Lista de productos de EOI")
...
def add_product():
    ...
    products.append([
        name_data.get(),
        price_data.get(),
        add_description_entry.get("1.0", END)
    ])
...
products = [] # En esta variable lista guardamos los datos de los productos
